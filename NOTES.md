...
1. Why a swap fails without a temp variable because values get overwritten.
2. How x and y act as nicknames pointing directly to the original variables a and b.
